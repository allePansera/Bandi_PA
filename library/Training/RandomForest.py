...
class RandomForest(Classifier):
    ...
    def train(self):
        ...
        try:
            ...
            raise Exception(f"Error '{e}' training dataset with RandomForest classifier")
    ...
    def test(self):
        ...
        try:
            ...
            tpr, fpr, threshold = roc_curve(self.y_testing, y_predicted)
            ...
            raise Exception(f"Error '{e}' testing RandomForest classifier produced")
